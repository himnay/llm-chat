# <span style="color:hsl(97,80%,58%)">Observability Setup — Prometheus, Grafana, Tempo, Loki</span>
...
## <span style="color:hsl(235,80%,58%)">1. Start the stack</span>
...
## <span style="color:hsl(12,80%,58%)">2. Run the app</span>
...
## <span style="color:hsl(150,80%,58%)">3. Endpoints</span>
...
## <span style="color:hsl(287,80%,58%)">4. Grafana</span>
...
## <span style="color:hsl(65,80%,50%)">5. Tracing & log correlation</span>
...
## <span style="color:hsl(202,80%,58%)">Tuning</span>
